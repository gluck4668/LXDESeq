...
bioc_pack <- data.frame(c("DESeq2",'factoextra',"SummarizedExperiment","geneplotter"))
...
ggsave("analysis results/PCA.png", gg_pca,width=1000, height =900, dpi=150,units = "px")
